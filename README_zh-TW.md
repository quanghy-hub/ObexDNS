...
| 解析日誌 | 日誌詳情 |
|:---:|:---:|
| ![解析日誌](docs/screenshots/dns.obex-log.jpg) | ![日誌詳情](docs/screenshots/dns.obex-log_detail.jpg) |
...
| 行動端日誌 | 行動端統計 |
|:---:|:---:|
| ![行動端日誌](docs/screenshots/dns.obex-mobile_log.png) | ![行動端統計](docs/screenshots/dns.obex-mobile_stats.jpg) |
