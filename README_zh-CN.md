...
| 解析日志 | 日志详情 |
|:---:|:---:|
| ![解析日志](docs/screenshots/dns.obex-log.jpg) | ![日志详情](docs/screenshots/dns.obex-log_detail.jpg) |
...
| 移动端日志 | 移动端统计 |
|:---:|:---:|
| ![移动端日志](docs/screenshots/dns.obex-mobile_log.png) | ![移动端统计](docs/screenshots/dns.obex-mobile_stats.jpg) |
